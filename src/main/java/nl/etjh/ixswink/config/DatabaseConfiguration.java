package nl.etjh.ixswink.config;
...
@Configuration
@EnableR2dbcRepositories({ "nl.etjh.ixswink.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("nl.etjh.ixswink.repository.search")
