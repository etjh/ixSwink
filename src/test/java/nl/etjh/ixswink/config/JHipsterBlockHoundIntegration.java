...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("nl.etjh.ixswink.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("nl.etjh.ixswink.security.DomainUserDetailsService", "createSpringSecurityUser");
